...
const risk = document.getElementById("Cumulative Risk");
...
const cohens_d = document.getElementById("Cohen's D Effect");
const approx = document.getElementById("Approx. freq. of occ.");
const sign_level = document.getElementById("Significance Level");
...
function update_chart(type) {
    ...
    if (!isNaN(n_norm) && !isNaN(x_norm)) {
        p_expected.innerHTML = x_norm / n_norm;
    }
    var p = x / n;
    var v = variance(n, p);
    var sd = stdev(n, p);
